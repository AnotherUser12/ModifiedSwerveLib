...
public class DrivetrainSubsystem extends SubsystemBase {
    ...
    public DrivetrainSubsystem() {
        ...
        frontLeftModule = Mk3SwerveModuleHelper.createTalonSRX(
        ...
        frontRightModule = Mk3SwerveModuleHelper.createTalonSRX(
        ...
        backLeftModule = Mk3SwerveModuleHelper.createTalonSRX(
        ...
        backRightModule = Mk3SwerveModuleHelper.createTalonSRX(
