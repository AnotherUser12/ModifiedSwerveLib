...
public final class Mk3SwerveModuleHelper {
    ...
    private static SteerControllerFactory<?, TalonSRXSteerConfiguration<CanCoderAbsoluteConfiguration>> getFalcon500SteerFactory(Mk3ModuleConfiguration configuration) {
